...
for i in xrange(3, 17):
	for j in xrange(3, 17):
		product = max(reduce(mul, (matrix[i+n][j] for n in [0, 1, 2, 3])),
			          reduce(mul, (matrix[i-n][j] for n in [0, 1, 2, 3])),
			          reduce(mul, (matrix[i][j+n] for n in [0, 1, 2, 3])),
			          reduce(mul, (matrix[i][j-n] for n in [0, 1, 2, 3])),
			          reduce(mul, (matrix[i-n][j-n] for n in [0, 1, 2, 3])),
			          reduce(mul, (matrix[i+n][j+n] for n in [0, 1, 2, 3])),
			          reduce(mul, (matrix[i-n][j+n] for n in [0, 1, 2, 3])),
			          reduce(mul, (matrix[i+n][j-n] for n in [0, 1, 2, 3])))
